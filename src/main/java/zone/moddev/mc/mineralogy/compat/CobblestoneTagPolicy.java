...
/** Applies the legacy cobblestone option to Forge 61 canonical and compatibility tags. */
public final class CobblestoneTagPolicy {
    ...
    public static void apply(HolderLookup.Provider access) {
        ...
        Mineralogy.LOGGER.debug("Applied Forge 61 cobblestone policy: enabled={}, rocks={}, "
