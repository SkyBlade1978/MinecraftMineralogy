...
The native stone-spear recipe and advancement already use
`minecraft:stone_tool_materials`, so they need no override. They follow the
same enabled/disabled membership policy through that tag.
