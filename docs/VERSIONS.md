...
this Minecraft 1.21.11 Forge release is therefore:
...
`6.1.1.121111`, not `1.21.11-6.1.1.121111`. The Target already makes tags unique
...
| 1.21.11 | Forge | `121111` | `6.1.1.121111` |
| 26.2 | Forge | `2602001` | `6.0.0.2602001` |
| 26.2 | NeoForge | `2602002` | `6.0.0.2602002` |

The 1.21.11 row records this branch's current release. The other rows illustrate
...
```text
6.1.1.121111 -> 6.2.0.121111
6.2.4.121111 -> 7.0.0.121111
```
...
Minecraft 1.21.11 / Forge / Mineralogy 6.1.1.121111
```
...
target calculation, so the matching Minecraft 1.21.11 Forge release used for
this candidate is `4.0.16.121111`. The dependency range deliberately describes the supported
...
branch, published metadata and artifacts therefore use `6.1.1.121111`.
