...
`6.1.2.121111`, not `1.21.11-6.1.2.121111`. The Target already makes tags unique
...
branch, published metadata and artifacts therefore use `6.1.2.121111`.
