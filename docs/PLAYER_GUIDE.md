...
families. Native raw, polished, and brick tuff construction recipes remain
available, while matching slab recipes deliberately produce Mineralogy's
upright-capable slabs. Put either slab by itself in a crafting grid to convert
between the native and Mineralogy form without loss. Native smooth basalt also
works wherever Mineralogy expects smooth basalt, while Minecraft's normal
basalt-smelting recipe is left unchanged.
