...
if ($Check) {
    if (-not (Test-Path -LiteralPath $definitionRoot)) {
        throw "Missing Minecraft 1.21.11 item-definition directory $definitionRoot"
    }
    ...
    Write-Output 'Verified 928 Minecraft 1.21.11 Mineralogy item definitions.'
    return
}
...
Write-Output 'Generated 928 Minecraft 1.21.11 Mineralogy item definitions.'
